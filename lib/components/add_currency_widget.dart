              ...
              Padding(
                ...
                child: FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewGetCurrenciesResponse = snapshot.data!;
                    return Builder(
                      builder: (context) {
                        final currencies = GetCurrenciesCall.code(
                              listViewGetCurrenciesResponse.jsonBody,
                            )?.toList() ??
                            [];
                        return ListView.builder(
                          ...
                          itemBuilder: (context, currenciesIndex) {
                            final currenciesItem = currencies[currenciesIndex];
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await CurrencyRecord.collection
                                      .doc()
                                      .set(createCurrencyRecordData(
                                        code: currenciesItem,
                                      ));
